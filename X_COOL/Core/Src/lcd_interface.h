...
typedef struct
{
	...
	int8_t deviation_fridge;
	int8_t deviation_freezer;
...
typedef enum
{
	...
	LCD_SERVICE_TEMPERATURE_FRIDGE_SETPOINT_STATE,
	LCD_SERVICE_TEMPERATURE_FRIDGE_DEVIATION_STATE,
	LCD_SERVICE_TEMPERATURE_FRIDGE_BACK_STATE,

	LCD_SERVICE_TEMPERATURE_FREEZER_SETPOINT_STATE,
	LCD_SERVICE_TEMPERATURE_FREEZER_DEVIATION_STATE,
	LCD_SERVICE_TEMPERATURE_FREEZER_BACK_STATE,

	LCD_SERVICE_TEMPERATURE_FRIDGE_SETPOINT_SET_STATE,
	LCD_SERVICE_TEMPERATURE_FRIDGE_DEVIATION_SET_STATE,

	LCD_SERVICE_TEMPERATURE_FREEZER_SETPOINT_SET_STATE,
	LCD_SERVICE_TEMPERATURE_FREEZER_DEVIATION_SET_STATE,
...
typedef enum
{
	LCD_SET_OPERATION_MODE_EVT = 0,

	LCD_SET_DATETIME_EVT,
	LCD_SET_TEMPERATURE_FRIDGE_SETPOINT_EVT,
	LCD_SET_TEMPERATURE_FRIDGE_DEVIATION_EVT,
	LCD_SET_TEMPERATURE_FREEZER_SETPOINT_EVT,
	LCD_SET_TEMPERATURE_FREEZER_DEVIATION_EVT,
